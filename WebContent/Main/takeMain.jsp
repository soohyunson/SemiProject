            ...
            <div class="challegneMiddleContainer">
               ...
               <div class="slideShow" align="center" style="width: 1200px;">
                  <c:forEach var="i" begin="0" end="5">
                     <div class="slideDiv">
                        ...
                        <h3 class="slideTitle"><a href = "${pageContext.request.contextPath}/fromList.usboard?seq=${list.get(i).seq}">${lifelist.get(i).title}</a></h3>
               ...
               <div class="slideShow" align="center" style="width: 1200px;">
                  <c:forEach var="i" begin="0" end="5">
                     <div class="slideDiv">
                        <img src="b.png" class="slideImg">
                        <h3 class="slideTitle"><a href = "${pageContext.request.contextPath}/fromList.usboard?seq=${list.get(i).seq}">${healthlist.get(i).title}</a></h3>
               ...
               <div class="slideShow" align="center" style="width: 1200px;">
                  <c:forEach var="i" begin="0" end="5">
                     <div class="slideDiv">
                        <img src="b.png" class="slideImg">
                        <h3 class="slideTitle"><a href = "${pageContext.request.contextPath}/fromList.usboard?seq=${list.get(i).seq}">${exlist.get(i).title}</a></h3>
