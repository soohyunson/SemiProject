  ...
  <div class="wrap">
    ...
    <div class="container">
      <div class="mainCategory">
        <div><img src="${pageContext.request.contextPath }/Img/exercise.png" class="categoryImg">
          <div class="categoryTitle" id="exerciseCategory">운동</div>
        </div>
        <div><img src="${pageContext.request.contextPath }/Img/exercise.png" class="categoryImg secondCategoryImg">
          <div class="categoryTitle" id="habitCategory">습관</div>
        </div>
        <div><img src="${pageContext.request.contextPath }/Img/study.png" class="categoryImg">
