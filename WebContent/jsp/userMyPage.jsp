...
<progress id="file" max="100" value="70" style="width: 100%; background-color: purple;"> 70% </progress>
            ...
            <div class="twofloor">
             <br><br>
                <div style="text-align:start; margin-left: 5%;"><a href="#" class="submenu">My Point </a></div>
                <br><br>
       ...
       <br>
            ...
            <div class="fourfloor">
             <br><br>
                <div style="text-align:start; margin-left: 5%;"><a href="#"class="submenu">My Statics</a></div>
                <br><br>
                <div >
...
Copyright ⓒ2019 Miwansung inc, ltd. All rights reserved</div><br>
        ...
        <div class="wrapper">
            <br>
            <div class="sidebar"><a href="#">My Profile</a></div>
            <div class="sidebar"><a href="#">My Information</a></div>
            <div class="sidebar"><a href="#">My Challenge</a></div>
            <div class="sidebar"><a href="#">My Point</a></div>
            <div class="sidebar"><a href="#">Membership Withdrawal</a></div>
            </div>
        </div>
        <ul class="navi">
          <ul class="title">
...
>>>>>>> f5d5d676cf86da11fa2eb6bd877def83c7e53fa4
	...
	<ul class="navi">
		<ul class="title">
			<li class="navi-title"><a href="#"><img src="Img/reallogo.png" class="mr-3" alt="..."
>>>>>>> f5d5d676cf86da11fa2eb6bd877def83c7e53fa4
